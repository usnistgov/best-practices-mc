...
A better choice is a quaternion ${\bf q}$, which is a normalized, four-element vector.\cite{?}
...
$10^6$ trials, $10^2$ bins, $10$ simulations, $\delta \theta_{max}=\pi/10$.
...
\begin{equation}
\alpha_{o\rightarrow n}=\alpha_{n\rightarrow o} = \frac{\diff\mathbf{\omega}\diff\theta}{N_m 4\pi\delta}.
...
\begin{tabular}{|c|c|}
 ...
 \hline
 \makecell{Choose rotation angle} & \makecell{$\diff\theta/\delta$} \\
 \hline\hline
